...
export default function CustomerSupportChat() {
  ...
  if (!common.customerSupportModal) return null;
              ...
              >
                ...
                <div
                  className={`p-3 rounded-2xl ${
                    msg.isBot
                      ? "bg-black border border-gray-800 text-white rounded-tl-md"
            ...
            <div className="relative">
              <div className="bg-black border border-gray-800 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-gray-300 text-xs">Image to send:</span>
                  <button
                    onClick={removeImage}
                ...
                <button
                  ...
                  className={`text-xs p-2 rounded-lg border transition-all duration-200 hover:scale-105 ${
                    selectedOption === option
                      ...
                      : "bg-transparent text-gray-300 border-gray-700 hover:border-gray-500 hover:bg-secondary"
                  }`}
                >
                  {option}
                </button>
        ...
        <div className="p-4 border-t border-gray-800 bg-black">
          <div className="flex gap-2">
            ...
            <button
              ...
              className="w-10 h-10 bg-black rounded-full flex items-center justify-center hover:bg-secondary  transition-all duration-200 hover:scale-105 active:scale-95 border border-gray-700"
            >
              <svg
                width={16}
                height={16}

...
export default function FilterInput({ inputTitle,filterItems }) {
  ...
  return (
    <select
      ...
      className="bg-dark-800/80 border border-gray-600/50 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-transparent transition-all duration-200"
    >

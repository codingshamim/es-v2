...
export default function CartItem({
  ...
  return (
    <div className="grid mt-2 nav-border grid-cols-12 gap-4 shadow-lg p-2">
      ...
      <div className={`col-span-12 ${mode === "checkout" ? "md:col-span-3" : "md:col-span-2"} flex md:text-center md:justify-center  items-center `}>
        <span className="md:hidden "> Price :</span>
        <p className="text-gray-300 text-xs ml-2 md:text-center "> {originalPrice}</p>
      </div>
      ...
      <div className={`col-span-12  md:text-center flex  md:justify-center  items-center ${mode === "checkout" ? "md:col-span-2" : "md:col-span-1"}`}>
      ...
      <div className="col-span-12 md:col-span-2 flex md:text-center  md:justify-center  items-center">
        ...
        <p className="text-gray-300  ml-2 text-xs md:text-center "> {totalPrice}</p>
      </div>
      {mode === "checkout" || (
        <div className={`col-span-12  flex items-center gap-2 ${mode === "checkout" ? "md:col-span-2" :"md:col-span-1"}`}>
          <EditCartButton
            quantity={quantity}
            size={size}
            cartId={cartId}
